This is a modified and updated version of the information below. The modifications allows for the most current versions of the packages that were used in the initial repository.
